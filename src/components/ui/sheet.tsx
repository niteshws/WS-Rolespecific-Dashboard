...
export function Sheet({
  ...
  return (
    <div className="fixed inset-0 z-50" role="dialog" aria-modal="true" aria-label={typeof title === "string" ? title : "Panel"}>
      ...
      <div
        className={cn(
          "absolute right-0 top-0 flex h-full flex-col bg-background shadow-pop",
      ...
      >
        ...
        <div className="thin-scrollbar min-h-0 flex-1 overflow-y-auto px-6 py-5">{children}</div>
