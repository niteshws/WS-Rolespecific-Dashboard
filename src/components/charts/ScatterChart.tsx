        ...
        {yTicks.map((t) => (
          <g key={t}>
            <line
              ...
              strokeDasharray="3 3"
            />
            <text x={pad.l - 8} y={sy(t) + 3} textAnchor="end" fontSize="9" fill="#6b7280">
              {t}%
            </text>
          </g>
        ))}
        {xTicks.map((t) => (
          <text key={t} x={sx(t)} y={H - 10} textAnchor="middle" fontSize="9" fill="#6b7280">
            {t}h
          </text>
        ))}
        <text x={pad.l} y={H - 22} fontSize="9" fill="#6b7280" opacity="0" />
