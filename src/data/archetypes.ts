...
export const ARCHETYPES: _A[] = [
  /* ------------------------------- Executive ---------------------------- */
  {
    ...
    insights: [
      ...
      },
      {
        id: "ceo-i2",
        severity: "bad",
        title: "Low activity on 5 members",
        body: "5 members are below 35% activity today, with idle time rising. Check focus apps and workload before it pulls team productivity down.",
        metricRef: "Today's Activity",
        action: "View least-tracked members",
        reportKey: "tracked-least-hours",
      }
    ],
    kpis: [
    ...
    widgets: [
      ...
      { id: "w-time-log-approval", type: "barList", size: "half-short", layer: 3, title: "Time Log Approval Status", info: "Approval status of submitted time logs this period", actionLabel: "View report", reportKey: "time-log-approval", payload: timeLogApprovalStatus },
  ...
  /* -------------------------------- PMO --------------------------------- */
  {
    ...
    description: "Project delivery status, budget burn, and progress metrics.",
    icon: "KanbanSquare",
    visibility: "private",
    owner: "Vinove Design",
    templateId: "pmo",
    ...
    widgets: [
      {
        ...
        info: "Overview of project spending vs. allocated budget",
        icon: "Coins",
      ...
      },
      {
        ...
        info: "Trend of created vs completed tasks over time",
        icon: "CalendarPlus",
        actionLabel: "View report",
      ...
      { id: "w-scatter", type: "scatter", size: "half-tall", layer: 2, title: "Velocity vs. Capacity", reportKey: "velocity-capacity", payload: scatter },
      ...
      { id: "w-table", type: "dataTable", size: "full-tall", layer: 3, title: "Project Delivery Ledger", reportKey: "projects", payload: projectTable },
    ],
  },
